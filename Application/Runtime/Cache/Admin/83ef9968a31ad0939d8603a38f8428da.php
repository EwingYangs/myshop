...
<div class="main-div">
  <form action="/index.php/Admin/Attribute/add/type_id/2.html" method="post" name="theForm" >
  <table width="100%" id="general-table">
      ...
      <tr>
        ...
        <td>
          <input type="radio" name="attr_type" value="0" checked="true"> 唯一属性          <input type="radio" name="attr_type" value="1"> 单选属性                  <br><span class="notice-span" style="display:block" id="noticeAttrType">选择"单选/复选属性"时，可以对商品该属性设置多个值，同时还能对不同属性值指定不同的价格加价，用户购买商品时需要选定具体的属性值。选择"唯一属性"时，商品的该属性值只能设置一个值，用户只能查看该值。</span>
        </td>
      </tr>
      <tr>
