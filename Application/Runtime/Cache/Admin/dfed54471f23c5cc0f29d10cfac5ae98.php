...
<div class="main-div">
    <form name="main_form" method="POST" action="/index.php/Admin/Category/edit/id/1.html" enctype="multipart/form-data">
            ...
            <tr>
                ...
                <td>
                	<select name="parent_id">
                		...
                		<?php foreach($cat_data as $k=>$v){ if($v['cat_id'] == $data['cat_id'] || in_array($v['cat_id'],$sub_ids)){ continue; } ?>
                			<option value="<?php echo $v['cat_id']?>" <?php if($v['cat_id'] == $data['parent_id']){echo 'selected=selected';}?>>
